...
class AddTransactionSheet extends StatefulWidget {
  ...
  static Future<void> show(BuildContext context, {bool isExpense = true}) {
    return showModalBottomSheet(
      ...
      builder: (_) => AddTransactionSheet(initialIsExpense: isExpense),
    );
  }
...
class _AddTransactionSheetState extends State<AddTransactionSheet> {
  ...
  void initState() {
    ...
    _category = _isExpense ? TransactionCategory.food : TransactionCategory.other;
